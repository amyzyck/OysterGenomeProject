...
ld <- read.csv("~/Google Drive/Eastern Oyster Genome/Population Structure/geno_ld_window_4000-5000.txt")
...
for (i in 1:length(chrs)){
  ...
  pdf(paste0("LDplot_5000-5000",chrs[i],".pdf"), width=20, height=5)
  layout(1)
  par(mar=c(3,4,3,1))
